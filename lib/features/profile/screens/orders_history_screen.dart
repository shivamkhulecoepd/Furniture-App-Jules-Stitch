      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _buildStatBox('Total Orders', '24', isDark)),
                SizedBox(width: 16.w),
                Expanded(child: _buildStatBox('Ongoing Delivery', '1', isDark)),
              ],
            ),
            ...
            _buildOrderCard(
              ...
              price: '890.00',
              imageUrl:
                  'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=200&auto=format&fit=crop',
              itemCount: 1,
              actionText: 'Details',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          Text(value, style: AppTextStyles.h2.copyWith(fontSize: 24.sp)),
        ],
      ),
    );
  }
